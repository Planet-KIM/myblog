...
cv_profile = {
    ...
    "role_ko": "KAIST 의과학대학원(GSMSE) jklab 연구원 · Machine Learning & BioAI",
    "role_en": "Researcher, KAIST jklab (Genomic Analysis Lab), GSMSE, KAIST · ML & BioAI",
    "intro_ko": (
        "KAIST 의과학대학원 jklab(유전체 분석 연구실)에서 "
        "유전체 서열 기반 변이 해석 연구를 수행하고 있습니다. "
        "SpliceAI, LaBranchoR, MaxEntScan, Optimus 5′UTR 등을 직접 재현·현대화하고, "
        "이를 통합한 multi-model variant interpretation pipeline과 "
        "Genomic DataPortal을 설계·운영하는 연구 지향 개발자입니다."
    ),
    "intro_en": (
        "I work at jklab, a genomic analysis lab in GSMSE, KAIST, focusing on "
        "genomic sequence–based variant interpretation. I reproduce and modernize "
        "SpliceAI, LaBranchoR, MaxEntScan, Optimus 5′UTR, and design a "
        "multi-model variant interpretation pipeline and Genomic DataPortal used by researchers."
    ),
}
...
experience = {
    "ko": {
        ...
        "period": "2022.05 – 현재",
        "bullets": [
            "유전체 분석을 수행하는 jklab에서 BioAI·전산 파트를 담당하며 Genomic DataPortal을 설계·개발.",
    ...
    "en": {
        ...
        "bullets": [
            "Lead the computing and AI track in jklab, designing and developing the Genomic DataPortal.",
...
projects = [
    {
        ...
        "meta_ko": "Multi-model integration · Variant interpretation · Genomic DataPortal",
        "meta_en": "Multi-model integration · Variant interpretation · Genomic DataPortal",
        "bullets_ko": [
    ...
    },
    {
        ...
        "meta_ko": "CRISPR/ASO 설계 · 종 간 서열 보존도 기반 off-target 위험도 정량화",
        "meta_en": "CRISPR/ASO design · Cross-species conservation-based off-target risk scoring",
        "bullets_ko": [
